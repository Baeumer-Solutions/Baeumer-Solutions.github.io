...
(function(){
  ...
  var NAV = [
    {href:"/das-system/", label:"Das System"},
    {href:"/ablauf-experten/", label:"Ablauf & Experten"},
    {href:"/lagebild/", label:"Lagebild"},
    {href:"/community/", label:"Community"},
    {href:"/faq-kontakt/", label:"FAQ & Kontakt"}
  ];
  ...
  function buildHeader(active){
    return '<header class="site-header"><div class="wrap">'+
      '<a class="brand" href="/"><img class="brandlogo" src="/assets/logo-weiss.png" alt="Protect-12"></a>'+
      ...
      '<a href="/">Start</a>'+navLinks(active)+
    ...
    return '<footer class="site-footer">'+SHIELD+'<div class="wrap">'+
      '<div class="cols">'+
        ...
        '<div><h4>Das System</h4>'+
          '<a href="/das-system/">Zw&ouml;lf Bereiche</a><a href="/das-system/#szenarien">Acht Szenarien</a>'+
          '<a href="/das-system/#unterlagen">F&uuml;nfzehn Unterlagen</a><a href="/lagebild/">Lagebild</a></div>'+
        '<div><h4>Mehr</h4>'+
          '<a href="/ablauf-experten/">Ihr Weg</a><a href="/ablauf-experten/#experten">Expertennetzwerk</a>'+
          '<a href="/community/">Community</a><a href="/ratgeber/">Ratgeber</a>'+
          '<a href="/faq-kontakt/">Fragen &amp; Antworten</a></div>'+
        '<div><h4>Kontakt</h4>'+
